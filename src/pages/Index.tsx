...
const Hero = () => {
  ...
  return (
    <section ref={ref} className="relative min-h-[85vh] flex flex-col justify-center overflow-hidden pt-5">
            ...
            {markets.map((node, i) => (
              ...
              >
                <div className="flex items-center gap-5 py-4 border-b border-border/15 group hover:border-primary/15 transition-colors duration-500">
                  <img src={`https://flagcdn.com/w80/${node.code}.png`} alt={node.market} loading="lazy" width={80} height={60} className="w-8 h-8 rounded-full object-cover" />
