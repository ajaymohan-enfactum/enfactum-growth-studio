...
const capabilityData: Record<string, CapData> = {
    ...
    proof: [
      {
        ...
        capability: "Market Entry · Partner Ecosystems",
      ...
      {
        title: "Enterprise SaaS ASEAN Expansion",
        capability: "Channel Strategy · Revenue Operations",
        region: "Singapore · Malaysia · Indonesia · Thailand · Vietnam",
        outcomes: [
          { metric: "4x", label: "Pipeline growth across ASEAN" },
          { metric: "35+", label: "Channel partners activated" },
          { metric: "6mo", label: "Time to first revenue" },
        ],
        insight: "Channel programmes succeed when they're operationalised, not just designed.",
      },
    ],
    team: {
  ...
  "brand-demand": {
    ...
    proof: [
      {
        title: "Consumer Electronics Regional Campaign",
        capability: "Performance · Social · Influencer",
        region: "Singapore · Malaysia · Indonesia",
        outcomes: [
          { metric: "320%", label: "ROAS improvement" },
          { metric: "3", label: "Markets activated simultaneously" },
          { metric: "2.4x", label: "Conversion rate lift" },
        ],
        insight: "Integrated demand outperforms channel-siloed execution by multiples, not percentages.",
      },
      {
        title: "DTC Brand Launch SEA",
        capability: "Creative · Performance · Affiliate",
        region: "Malaysia · Thailand",
        outcomes: [
          { metric: "40K", label: "Customers in first quarter" },
          { metric: "18%", label: "Repeat purchase rate" },
          { metric: "$2.40", label: "Blended CPA" },
        ],
        insight: "DTC in Southeast Asia requires locally adapted creative, not translated global assets.",
      },
    ],
    team: {
    ...
    proof: [
      {
        ...
        capability: "Thought Leadership · Audience Strategy · Demand",
      ...
      {
        title: "Regional Partner Summit Series",
        capability: "Partner Activation · Channel Events",
        region: "Singapore · Kuala Lumpur · Jakarta",
        outcomes: [
          { metric: "120", label: "Partners activated" },
          { metric: "$2M", label: "Pipeline generated" },
          { metric: "85%", label: "Partner programme enrolment" },
        ],
        insight: "Partner summits should activate, not just inform.",
      },
    ],
    team: {
